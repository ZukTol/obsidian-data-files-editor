...
- Run `pnpm build` before submitting to confirm the type-check and bundle succeed.
...
- Editor views are built on CodeMirror 6; keep extension wiring in the relevant `src/views/` and `src/services/` modules.
